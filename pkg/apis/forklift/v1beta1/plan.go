...
type PlanSpec struct {
	...
	// XfsCompatibility enables XFSv4 compatibility mode for virt-v2v and deep-inspection
	// workloads on this plan. Pods use the cluster VIRT_V2V_IMAGE (or plan virtV2vImage)
	// and select the RHEL 9 libguestfs fixed appliance via LIBGUESTFS_PATH.
	// Use this for VMs with XFSv4 source filesystems on specific plans.
