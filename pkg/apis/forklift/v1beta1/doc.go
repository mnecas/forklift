...
const (
	...
	PhaseCreateCopyAppliance               = "CreateCopyAppliance"
	PhaseRefreshCopyAppliance              = "RefreshCopyAppliance"
	PhaseReleaseCopyAppliance              = "ReleaseCopyAppliance"
	// Cutover variants must be uniquely named: itinerary.Next matches by name.
	PhaseReleaseCopyApplianceBeforeCutover     = "ReleaseCopyApplianceBeforeCutover"
	PhaseRefreshCopyApplianceBeforeFinalize    = "RefreshCopyApplianceBeforeFinalize"
	PhaseReleaseCopyApplianceBeforeFinalSnap   = "ReleaseCopyApplianceBeforeFinalSnap"
	...
	PhaseTeardownCopyAppliance             = "TeardownCopyAppliance"
	...
	PhaseWaitForCopyAppliance              = "WaitForCopyAppliance"
	PhaseWaitForCopyApplianceReleased      = "WaitForCopyApplianceReleased"
	PhaseWaitForRefreshedCopyAppliance     = "WaitForRefreshedCopyAppliance"
	PhaseWaitForCopyApplianceReleasedBeforeCutover  = "WaitForCopyApplianceReleasedBeforeCutover"
	PhaseWaitForRefreshedCopyApplianceBeforeFinalize = "WaitForRefreshedCopyApplianceBeforeFinalize"
	PhaseWaitForCopyApplianceReleasedBeforeFinalSnap = "WaitForCopyApplianceReleasedBeforeFinalSnap"
